...
export const CarCardContainer: FC<CarCardContainerProps> = () => {
    ...
    const handleApplyFilters = async (filters: Partial<ICarType>) => { 
        setLoading(true); 
        try { 
            const { cars: filteredCars, totalCount } = await fetchFilteredCarData(filters, page, PAGE_SIZE); 
    ...
    return (
        <div className="grid grid-cols-5">
            <FiltersContainer filters={filters} onApplyFilters={handleApplyFilters}/>
